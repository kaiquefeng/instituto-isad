<div class="footer-area">
            <div class="footer-top_area bg-marrom">
                <div class="container">
                    <div class="row">
                    ...
                    <div class="row align-items-center">
                        <div class="col-md-6">
                            <div class="copyright">
                                ...
                                <a href="index.html">Agência Creature.</a>
                                <a href="https://hasthemes.com/" target="_blank"> | Todos os direitos reservados</a>
                            </span>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="payment">
                                <img src="assets/images/footer/payment/1.png" alt="Quciky's's Payment Method">
                            </div>
                        </div>
                    </div>
                </div>
